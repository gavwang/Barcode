...
public class ShipmentPrinter implements Printable
{
    ...
    private List<ProductShipment> shipments;
    private TableModel model = null;   
    private String info;   
    private int totalRow = 0; 
    //private JTable tableView = null;
     
    public ShipmentPrinter(List<ProductShipment> p)
    {
        shipments = p;
    }
    
    class ShipDataModel extends AbstractTableModel
    {

        public ShipDataModel(List<ProductShipment> p)
        {
            shipments = p;
        }
        private List<ProductShipment> shipments;
        private String[] header = {"No.", "OrderNo", "ProductCode","SeriesNo", "Time"};
        @Override
        public Object getValueAt(int rowIndex, int columnIndex)
        {
            ProductShipment p = shipments.get(rowIndex);
    ...
    {
        printTable(new ShipDataModel(shipments), "Test");
    }
     ...
     * @param height  
     */  
    private void drawCell(Graphics g, Object value, int x, int y,   
            int width,   
